  ...
  <div class="section-wrapper flex flex-col">
    <div class="title-wrapper flex-col items-start">
      ...
      <ol class="flex items-center whitespace-nowrap">
        ...
        <li class="inline-flex items-center">
          <div class="flex items-center text-sm font-medium text-gray-500">Edit Kategori</div>
        </li>
      </ol>
    </div>

    <form wire:submit.prevent="update" class="content-wrapper flex-auto flex-col justify-between">
      <div class="space-y-3">
